...
insert into department values (1, 'Programming Technologies', 1);
insert into department values (2, 'Theoretical Cybernetics', 1);
insert into department values (3, 'Intellectual Robotics', 2);
